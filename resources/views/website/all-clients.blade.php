...
@section('page-meta')
@php
    $pageTitle = 'Our Clients || DTech Corporation';
    $pageDescription = 'Meet the clients who trust DTech Corporation for facade design, engineering, and construction solutions.';
@endphp
