...
@section('page-meta')
@php
    $pageTitle = 'Residential Projects || DTech Corporation';
    $pageDescription = 'Explore residential facade design projects completed by DTech Corporation across Bangladesh.';
@endphp
